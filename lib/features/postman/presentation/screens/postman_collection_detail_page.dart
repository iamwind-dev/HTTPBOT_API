...
import '../widget/postman_shell_action_button.dart';
...
class PostmanCollectionDetailPage extends StatelessWidget {
  ...
  /// Builds collection detail as a full-screen route above the tab shell.
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<PostmanCubit, PostmanState>(
      builder: (context, state) {
        final currentCollection = state.selectedCollection ?? collection;
        return _buildPage(context, currentCollection);
      },
    );
  }

  /// Composes the current collection snapshot into the full-screen scaffold.
  Widget _buildPage(
    BuildContext context,
    PostmanCollectionEntity currentCollection,
  ) {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: _PostmanDetailView(collection: currentCollection),
              ),
            ],
          ),
        ),
...
class _CollectionDetailCircleAction extends StatelessWidget {
  const _CollectionDetailCircleAction({required this.icon, this.onTap});

  final IconData icon;
  final VoidCallback? onTap;

  /// Builds a circular header action with a Material touch target.
  @override
  Widget build(BuildContext context) {
    final colors = context.appColors;
...
class _PostmanActionMenuItem extends StatelessWidget {
  ...
  /// Builds one action row for folder and request menus.
  @override
  Widget build(BuildContext context) {
    final colors = context.appColors;
...
class _PostmanDialogButton extends StatelessWidget {
  ...
  /// Builds a dialog action button shared by detail confirmations.
  @override
  Widget build(BuildContext context) {
    final colors = context.appColors;
...
class _EditorCard extends StatelessWidget {
  ...
  /// Builds the surface container used by the cURL import editor.
  @override
  Widget build(BuildContext context) {
    final colors = context.appColors;
...
class _HeaderCircleButton extends StatelessWidget {
  ...
  /// Builds a circular action for the cURL import page header.
  @override
  Widget build(BuildContext context) {
    final colors = context.appColors;
